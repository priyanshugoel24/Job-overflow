...
export default function Login (){
    ...
    return (
        <main className="w-full h-screen flex flex-col items-center py-20 bg-whitesmoke sm:px-4">
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    
                    <div className="mt-5 space-y-2">
                        <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Log in to your account</h3>
                        <p className="">Don't have an account? <Link href= "/signup"><button className="font-medium text-indigo-600 hover:text-indigo-500">Sign up</button></Link></p>
                    </div>
                </div>
                <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    <div className="grid grid-cols-3 gap-x-3">
                        ...
                        <button onClick={() => {signIn("twitter")}} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button onClick={() => {signIn("github")}} id = "github" className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-center">
                    <Link href = "/reset-password"><button  className="hover:text-indigo-600">Forgot password?</button></Link>
                </div>
            </div>
